    ...
    <main>
        ...
        <div class="user-header">
            ...
            <div class="user-info">
                ...
                <br><?= htmlspecialchars($_SESSION['user_email']) ?></p>
                <p class="user-detail"><strong>Google ID:</strong>
                <br><?= htmlspecialchars($_SESSION['user_id']) ?></p>
            </div>
        </div>
...
<p>11. Use in Formal Context</p>
<p>12. Use in Informal Context</p>
<p>13. Use in Business Context</p>
<p>14. Use in Narrative Context</p>

<h2>Grammar & Structure</h2><br>
...
<h2>Sentence Usage & Construction</h2><br>
